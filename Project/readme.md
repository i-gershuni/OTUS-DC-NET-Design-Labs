...
Предлагаемая схема сети Предприятия с использованием топологии CLOS  и технологии VxLAN EVPN представлена на следующем рисунке:
...
[Презентация проекта](./Presentation/Презентация_проекта_igershuni.pptx)
