...
Но в данной работе проведем некоторый тюнинг настроек OSPF, используя знания, полученные на последнем занятии, посвященном построению Underlay сети с использованием OSPF. 
