...
В данной работе добавим клиентские сети и проанонсируем их по OSPF, а так же проведем некоторый тюнинг настроек OSPF, используя знания, полученные на последнем занятии: 
