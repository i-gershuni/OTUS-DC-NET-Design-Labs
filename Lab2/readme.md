...
### Выполнение
В общем и целом цель данной  работы уже была  достигнута в предыдущей [лабораторной работе №1](https://github.com/i-gershuni/OTUS-DC-NET-Design-Labs/tree/82b7ce8b1be000731163ed32d370006d2b370917/Lab1).
...
##### Проверяем IP-связность между клиентскими устройствами, выполнив ***ping*** с каждого устройства до всех его соседей:
![](./img/ping.png)
