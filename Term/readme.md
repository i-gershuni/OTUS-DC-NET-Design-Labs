...
В настоящем проекте выполнена базовая проработка данной и выработаны основные архитектурные решения. 

Однако, ограничения виртуальной лаборатории не позволяют в полной мере протестировать отказоустойчивость решения для различных сценариев отказов. Поэтому, дальнейшая проработка концепции требует тестирования на реальном оборудовании конкретного производителя. 
